...
var canEmit: boolean;
var emitSphere: GameObject;
var trampJump: float;
static var isTriActive: boolean;
...
function Awake()
{
	...
	emitSphere.collider.enabled = false;
	emitSphere.collider.isTrigger = false;
	//Get controller
	controller = GetComponent(CharacterController);
	canEmit = true;
	emitSphere.renderer.enabled = false;
...
{
	maxJumps = 0;
	emitSphere.renderer.enabled = true;
	emitSphere.collider.enabled = true;
	emitSphere.collider.isTrigger = true;
}
